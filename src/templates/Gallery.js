...
export default function Gallery() {
  ...
  return (
   <div className='cont-g' style={{background: "linear-gradient(45deg , #0bd2de , #0083f9)", width:"100%", height:"100%" ,display:"flex", }}>
    <div className="d-flex flex-wrap justify-content-center align-items-center" style={{ marginTop:"20px"}}>
        {allImages?.data?.map((value, index) => {
          return (
            <div
              style={{ width: "350px", height: "250px", overflow: "hidden",  padding:"1px",margin:"13px",}}
            >
              <img
                className="img-fluid"
                src={value.imgurl}
